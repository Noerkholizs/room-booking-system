...
import { useMyBookings } from "@/features/bookings/hooks/use-booking"
...
import { BookingFilter, BookingStatus, BookingWithRelations } from "@/features/bookings/server/types"
import { UpdateBookingModal } from "@/features/bookings/components/update-booking-modal"
import { DeleteBookingModal } from "@/features/bookings/components/delete-booking-modal"
...
export const MyBookings = () => {
  ...
  const handleDeleteClick = (booking: BookingWithRelations) => {
    setDeleteModal({
      open: true,
      booking,
    })
  ...
  return (
    <>
      ...
      {/* Update Modal */}
      <UpdateBookingModal
        booking={updateModal.booking}
        open={updateModal.open}
        onOpenChange={(open) => setUpdateModal({ open, booking: open ? updateModal.booking : null })}
      />
      ...
      <DeleteBookingModal
        ...
        onOpenChange={(open) => setDeleteModal({ open, booking: open ? deleteModal.booking : null })}
      />
    </>
  )
}