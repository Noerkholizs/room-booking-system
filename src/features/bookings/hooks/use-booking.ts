...
import { checkRoomAvailability, createBooking, deleteBooking, fetchBookingById, fetchMyBookings, fetchRooms, updateBooking } from "../api/api"
...
export const useCheckAvailability = () => {
  return useMutation({
    ...
    onError: (errors: AxiosError) => {
        const error = errors.response?.data as GlobalErrorResponse
        toast.error(error.message || 'Gagal cek ketersediaan')
    },
  })
}